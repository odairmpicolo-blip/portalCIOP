...
# GitHub Actions desativado — este é o fluxo oficial de atualização de incidentes.
set -euo pipefail
...
echo "Agendamento instalado (fluxo Mac — GitHub Actions desativado)."
...
echo ""
echo "Botão manual na Mesa (opcional):"
echo "  bash \"$SCRIPT_DIR/instalar-botao-incidentes-macos.sh\""
echo ""
echo "Teste manual:"
