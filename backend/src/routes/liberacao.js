...
async function importarPlanilhaParaDsql(dataDe, dataAte, origem) {
...
/** Planilha → DSQL (após gravação na planilha ou sync manual). */
...
/** Planilha → DSQL e retorno dos dados do dia. */
