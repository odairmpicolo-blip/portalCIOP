...
const BUS_FRAME_SRC = legacyUrl('/pages/onibus-agora.html?embed=native-app&v=20260713f')
...
export function LegacyPage() {
  ...
  const src = useMemo(() => {
    ...
    const url = legacyUrl(`/${path}?v=20260713f`)
  ...
  const syncNativeFrame = useCallback(
    (frame: HTMLIFrameElement | null) => {
      ...
      try {
        ...
        if (doc) injectLegacyNativeFrame(doc, { tracking })
      } catch {
        /* mesma origem */
      }
